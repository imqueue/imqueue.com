...
// they are synced into src/org/cli/*.md by scripts/sync-cli-wiki.ts. Everything
...
// the sidebar (src/org/cli/cli.11tydata.ts reads this file) follow automatically.
//
...
/** One chapter of the CLI User Guide: the wiki source, and the site's own editorial layer. */
export interface WikiPage {
  /** Filename in @imqueue/cli's wiki/. */
  wiki: string;
  /** Filename written under src/org/cli/. */
  out: string;
  /** The URL it publishes at. */
  url: string;
  /** Sidebar label. */
  nav: string;
  title: string;
...
const externalRewrites: Record<string, string | undefined> = {
  "https://imqueue.com": "/",
  "https://imqueue.com/": "/",
};

export { pages, externalRewrites };
