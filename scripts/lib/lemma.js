 ...
 * @returns {string} Its lemma, or the word unchanged when nothing applies.
 */
 ...
 *
 * @param {Set<string>} corpusWords Every token the corpus contains.
 * @returns {Array<{stem: string, sawAs: string}>}
 */
function report(corpusWords) {
