#!/usr/bin/env node
// check-api-versions.js — does the published API reference still match npm?
//
...
//
//   node scripts/check-api-versions.js          report; exit 1 if anything is stale
//   node scripts/check-api-versions.js --list   stale package names only, one per line
//
...
const { latestRelease } = require('./lib/npm-releases');
