...
published: false
description: "NestJS is a full application framework with a microservices module; @imqueue is a focused RPC transport. They're not really competitors — here's how they differ and how they can work together."
tags: node, typescript, microservices, programming
canonical_url: https://imqueue.org/blog/imqueue-vs-nestjs/
cover_image: https://imqueue.org/images/blog/imqueue-vs-nestjs.png
---
...
To see @imqueue's model in practice, the [Tutorial](https://imqueue.org/tutorial/) builds a multi-service app step by step.
