...
published: false
description: "REST is a fine choice for public, resource-oriented APIs. For internal service-to-service calls it's often ceremony over a plain function call. Here's when to drop it and what to reach for instead."
tags: node, typescript, microservices, rpc
canonical_url: https://imqueue.org/blog/internal-apis-dont-need-rest/
cover_image: https://imqueue.org/images/blog/internal-apis-dont-need-rest.png
---
...
The point is just to stop *defaulting* to REST for internal calls that are really function calls. At your edge, REST. Between your services, consider whether a typed RPC call says what you mean with less ceremony. If that resonates, [Getting Started](https://imqueue.org/get-started/) shows the RPC-style model in practice.
