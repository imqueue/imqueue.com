...
published: false
description: "When a downstream service slows down, HTTP tends to turn that into a cascading failure. A queue absorbs the spike instead. Here's the difference, and the trade-offs to watch."
tags: node, typescript, microservices, backpressure
canonical_url: https://imqueue.org/blog/backpressure-nodejs-services/
cover_image: https://imqueue.org/images/blog/backpressure-nodejs-services.png
---
