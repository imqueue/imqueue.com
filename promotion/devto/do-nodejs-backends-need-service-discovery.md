...
published: false
description: "Consul, etcd, DNS-SD — service discovery is a lot of machinery to stand up. Sometimes you genuinely need it; often you don't. Here's how to tell, and how a queue makes the question disappear."
tags: node, typescript, microservices, architecture
canonical_url: https://imqueue.org/blog/do-nodejs-backends-need-service-discovery/
cover_image: https://imqueue.org/images/blog/do-nodejs-backends-need-service-discovery.png
---
...
But if the honest reason you were about to install Consul is "so my Node.js services can find each other to make calls," a queue-based model likely makes that need disappear — one less distributed system to run. See [Getting Started](https://imqueue.org/get-started/) for how calls work without any addressing on your side.
