...
published: false
description: "Every service you call needs a client, and hand-maintained clients drift out of sync with the services they talk to. Here's why that happens and how to make the client fall out of the service for free."
tags: node, typescript, microservices, webdev
canonical_url: https://imqueue.org/blog/stop-hand-writing-microservice-clients/
cover_image: https://imqueue.org/images/blog/stop-hand-writing-microservice-clients.png
---
...
If maintaining a drawer full of clients is draining your team, this is the shape of the fix. The [Getting Started](https://imqueue.org/get-started/) guide walks from an empty terminal to a generated client in a few minutes.
