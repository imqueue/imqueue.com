...
published: false
description: "Real measured throughput for @imqueue's message queue — ~200k msg/sec unreliable, ~120k guaranteed on a 24-core box — what the delivery modes cost, and a reproducible harness to measure the figures that matter: yours."
tags: node, typescript, microservices, performance
canonical_url: https://imqueue.org/blog/benchmarking-imqueue-throughput/
cover_image: https://imqueue.org/images/blog/benchmarking-imqueue-throughput.png
---
...
To build the @imqueue side of such a comparison, [Getting Started](https://imqueue.org/get-started/) gets a service and a typed client running quickly, and [`@imqueue/core`](https://github.com/imqueue/core) contains the throughput harness described above.
