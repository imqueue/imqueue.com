...
published: false
description: "Most people know Redis pub/sub and stop there. Redis has richer primitives — lists, blocking pops, and streams — that make it a capable message bus. Here's a tour, and where each fits."
tags: node, typescript, microservices, redis
canonical_url: https://imqueue.org/blog/redis-message-bus-patterns/
cover_image: https://imqueue.org/images/blog/redis-message-bus-patterns.png
---
...
If you want to see the RPC layer built on these foundations, start with [Getting Started](https://imqueue.org/get-started/), or read the [Messaging API overview](https://imqueue.org/api/) for how the queue itself is exposed.
