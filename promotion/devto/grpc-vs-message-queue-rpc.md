...
published: false
description: "gRPC is the default answer for typed RPC — and a great one, especially across languages. For an all-Node.js back-end, routing RPC through a queue trades some of gRPC's strengths for a lot less infrastructure."
tags: node, typescript, microservices, programming
canonical_url: https://imqueue.org/blog/grpc-vs-message-queue-rpc/
cover_image: https://imqueue.org/images/blog/grpc-vs-message-queue-rpc.png
---
...
If the second description fits, the [Getting Started](https://imqueue.org/get-started/) guide gets you to a working typed call quickly.
