...
published: false
description: "For internal service-to-service traffic, the load balancer you run and operate is often solving a problem a message queue solves for free. Here's the competing-consumers pattern and what it removes."
tags: node, typescript, microservices, devops
canonical_url: https://imqueue.org/blog/load-balancing-microservices-without-a-load-balancer/
cover_image: https://imqueue.org/images/blog/load-balancing-microservices-without-a-load-balancer.png
---
...
If you're standing up a load balancer purely so internal services can share work, the competing-consumers model likely removes that need. The [Tutorial](https://imqueue.org/tutorial/) shows a multi-service app where scaling a service is just running more of it.
