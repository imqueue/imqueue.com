...
published: false
description: "End-to-end types across service boundaries are easy inside one process and hard the moment you cross a network. Here's how to keep them without hand-writing clients or maintaining a schema language."
tags: node, typescript, microservices, rpc
canonical_url: https://imqueue.org/blog/type-safe-service-communication-typescript/
cover_image: https://imqueue.org/images/blog/type-safe-service-communication-typescript.png
---
...
See [Getting Started](https://imqueue.org/get-started/) to try it, or the [API reference](https://imqueue.org/api/) for the full decorator and client-generation surface.
