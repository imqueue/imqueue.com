...
published: false
description: "\"Will I lose messages if a worker dies?\" is the right question — and the answer is a trade-off, not a yes/no. Here's how guaranteed delivery works, what it costs, and how to choose per workload."
tags: node, typescript, microservices
canonical_url: https://imqueue.org/blog/guaranteed-message-delivery-cost/
cover_image: https://imqueue.org/images/blog/guaranteed-message-delivery-cost.png
---
