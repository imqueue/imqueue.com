---
title: "allowPluginEnvConfig() function · @imqueue/dd-trace"
description: "Adds DD_TRACE_<ID>_ENABLED to the tracer's configuration allow-list."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/dd-trace","url":"/api/dd-trace/latest/"},{"name":"allowPluginEnvConfig","url":"/api/dd-trace/latest/dd-trace.allowpluginenvconfig/"}]
---
