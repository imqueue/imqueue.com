...
[Home](/api/) &gt; [@imqueue/rpc](/api/rpc/1.2.12/) &gt; [IMQLock](/api/rpc/1.2.12/rpc.imqlock/)
...
[deadlockTimeout](/api/rpc/1.2.12/rpc.imqlock.deadlocktimeout/)
...
[logger](/api/rpc/1.2.12/rpc.imqlock.logger/)
...
[acquire(key, callback)](/api/rpc/1.2.12/rpc.imqlock.acquire/)
...
[locked(key)](/api/rpc/1.2.12/rpc.imqlock.locked/)
...
[release(key, value, err)](/api/rpc/1.2.12/rpc.imqlock.release/)
