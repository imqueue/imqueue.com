...
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/1.17.1/"},{"name":"RedisCache","url":"/api/rpc/1.17.1/rpc.rediscache/"}]
noindex: true
...
```
**Implements:** [ICache](/api/rpc/1.17.1/rpc.icache/)
...
[name](/api/rpc/1.17.1/rpc.rediscache.name/)
...
[options](/api/rpc/1.17.1/rpc.rediscache.options/)
...
[ready](/api/rpc/1.17.1/rpc.rediscache.ready/)
...
[del(key)](/api/rpc/1.17.1/rpc.rediscache.del/)
...
[destroy()](/api/rpc/1.17.1/rpc.rediscache.destroy/)
...
[get(key)](/api/rpc/1.17.1/rpc.rediscache.get/)
...
[init(options)](/api/rpc/1.17.1/rpc.rediscache.init/)
...
[purge(keyMask)](/api/rpc/1.17.1/rpc.rediscache.purge/)
...
[set(key, value, ttl, nx)](/api/rpc/1.17.1/rpc.rediscache.set/)
