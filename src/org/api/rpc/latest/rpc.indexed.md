...
description: "Exposes a complex service type that carries an index signature."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/latest/"},{"name":"indexed","url":"/api/rpc/latest/rpc.indexed/"}]
---
