...
[Home](/api/) &gt; [@imqueue/rpc](/api/rpc/2.0.4/) &gt; [IMQLock](/api/rpc/2.0.4/rpc.imqlock/)
...
[deadlockTimeout](/api/rpc/2.0.4/rpc.imqlock.deadlocktimeout/)
...
[logger](/api/rpc/2.0.4/rpc.imqlock.logger/)
...
[acquire(key, callback, metadata)](/api/rpc/2.0.4/rpc.imqlock.acquire/)
...
[locked(key)](/api/rpc/2.0.4/rpc.imqlock.locked/)
...
[release(key, value, err)](/api/rpc/2.0.4/rpc.imqlock.release/)
