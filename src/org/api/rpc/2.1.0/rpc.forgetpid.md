---
title: "forgetPid() function · @imqueue/rpc v2.1.0 (archived)"
description: "Removes pid file for a given name and id"
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/2.1.0/"},{"name":"forgetPid","url":"/api/rpc/2.1.0/rpc.forgetpid/"}]
noindex: true
