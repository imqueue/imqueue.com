---
title: "IMQLock class · @imqueue/rpc v2.1.0 (archived)"
description: "Class IMQLock. Implements promise-based locks."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/2.1.0/"},{"name":"IMQLock","url":"/api/rpc/2.1.0/rpc.imqlock/"}]
noindex: true
...
[deadlockTimeout](/api/rpc/2.1.0/rpc.imqlock.deadlocktimeout/)
...
[logger](/api/rpc/2.1.0/rpc.imqlock.logger/)
...
[acquire(key, callback, metadata)](/api/rpc/2.1.0/rpc.imqlock.acquire/)
...
[locked(key)](/api/rpc/2.1.0/rpc.imqlock.locked/)
...
[release(key, value, err)](/api/rpc/2.1.0/rpc.imqlock.release/)
