...
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/2.1.0/"},{"name":"imqCallResolver","url":"/api/rpc/2.1.0/rpc.imqcallresolver/"}]
noindex: true
...
(data: any, res: [IMQRPCResponse](/api/rpc/2.1.0/rpc.imqrpcresponse/)<!-- -->) =&gt; void
