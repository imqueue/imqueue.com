...
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/2.1.0/"},{"name":"DEFAULT_REDIS_CACHE_OPTIONS","url":"/api/rpc/2.1.0/rpc.default_redis_cache_options/"}]
noindex: true
