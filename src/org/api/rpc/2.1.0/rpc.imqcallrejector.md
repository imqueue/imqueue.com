---
title: "imqCallRejector() function · @imqueue/rpc v2.1.0 (archived)"
description: "Builds and returns call rejector, which supports after call optional hook"
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/rpc","url":"/api/rpc/2.1.0/"},{"name":"imqCallRejector","url":"/api/rpc/2.1.0/rpc.imqcallrejector/"}]
noindex: true
...
(err: any, res?: [IMQRPCResponse](/api/rpc/2.1.0/rpc.imqrpcresponse/)<!-- -->) =&gt; void
