---
title: "BaseModel.syncIndex() method · @imqueue/sequelize"
description: "Builds and runs the statements that create one column index."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"BaseModel","url":"/api/sequelize/latest/sequelize.basemodel/"},{"name":"syncIndex","url":"/api/sequelize/latest/sequelize.basemodel.syncindex/"}]
sitemap: false
---
