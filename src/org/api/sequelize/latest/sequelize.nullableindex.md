...
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"NullableIndex","url":"/api/sequelize/latest/sequelize.nullableindex/"}]
---
...
Partial&lt;[NullableColumnIndexOptions](/api/sequelize/latest/sequelize.nullablecolumnindexoptions/)<!-- -->&gt;
