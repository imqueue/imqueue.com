---
title: "BaseModel.toGraph() method · @imqueue/sequelize"
description: "Builds a graph of this model's associations, following them transitively."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"BaseModel","url":"/api/sequelize/latest/sequelize.basemodel/"},{"name":"toGraph","url":"/api/sequelize/latest/sequelize.basemodel.tograph/"}]
sitemap: false
---
...
[Graph](/api/sequelize/latest/sequelize.graph/)<!-- -->&lt;typeof [BaseModel](/api/sequelize/latest/sequelize.basemodel/)<!-- -->&gt;
