---
title: "query.autoCountQuery() function · @imqueue/sequelize"
description: "The counting counterpart of query.autoQuery(), for the same fields and filter."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"query","url":"/api/sequelize/latest/sequelize.query/"},{"name":"autoCountQuery","url":"/api/sequelize/latest/sequelize.query.autocountquery/"}]
sitemap: false
---
