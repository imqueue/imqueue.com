---
title: "query namespace · @imqueue/sequelize"
description: "Turns a caller's serialized query into Sequelize options, and back out as SQL."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"query","url":"/api/sequelize/latest/sequelize.query/"}]
---
...
[autoCountQuery(model, fields, merge)](/api/sequelize/latest/sequelize.query.autocountquery/)


</td><td>

The counting counterpart of [query.autoQuery()](/api/sequelize/latest/sequelize.query.autoquery/)<!-- -->, for the same fields and filter.


</td></tr>
<tr><td>

[autoQuery(model, fields, merge)](/api/sequelize/latest/sequelize.query.autoquery/)
...
[buildWhereFromArray(data)](/api/sequelize/latest/sequelize.query.buildwherefromarray/)
...
[createEntity(model, input, fields, transaction)](/api/sequelize/latest/sequelize.query.createentity/)
...
[E(input)](/api/sequelize/latest/sequelize.query.e/)
...
[filtered(attributes, fields, model)](/api/sequelize/latest/sequelize.query.filtered/)
...
[foreignKeys(model, relations)](/api/sequelize/latest/sequelize.query.foreignkeys/)
...
[foreignKeysMap(parent, model)](/api/sequelize/latest/sequelize.query.foreignkeysmap/)
...
[getInclude(queryOptions, path)](/api/sequelize/latest/sequelize.query.getinclude/)
...
[L(str, values)](/api/sequelize/latest/sequelize.query.l/)
...
[mergeQuery(queryOptions, merge)](/api/sequelize/latest/sequelize.query.mergequery/)
...
[needNesting(model, fields)](/api/sequelize/latest/sequelize.query.neednesting/)
...
[orNull(value)](/api/sequelize/latest/sequelize.query.ornull/)
...
[overrideJoin(queryOptions, options)](/api/sequelize/latest/sequelize.query.overridejoin/)
...
[primaryKeys(model)](/api/sequelize/latest/sequelize.query.primarykeys/)
...
[pureFields(model, fields)](/api/sequelize/latest/sequelize.query.purefields/)
...
[safeSqlSpaceCleanup(input)](/api/sequelize/latest/sequelize.query.safesqlspacecleanup/)
...
[skip(obj, props)](/api/sequelize/latest/sequelize.query.skip/)
...
[sql(sqlQuery, values)](/api/sequelize/latest/sequelize.query.sql/)
...
[toLimitOptions(pageOptions)](/api/sequelize/latest/sequelize.query.tolimitoptions/)
...
[toOrderOptions(orderBy)](/api/sequelize/latest/sequelize.query.toorderoptions/)
...
[toWhereOptions(filter, inputType)](/api/sequelize/latest/sequelize.query.towhereoptions/)
...
[withRangeFilters(filter)](/api/sequelize/latest/sequelize.query.withrangefilters/)
...
[ForeignKeyMap](/api/sequelize/latest/sequelize.query.foreignkeymap/)
...
[PureDataFunction](/api/sequelize/latest/sequelize.query.puredatafunction/)
...
[pureData](/api/sequelize/latest/sequelize.query.puredata/)
