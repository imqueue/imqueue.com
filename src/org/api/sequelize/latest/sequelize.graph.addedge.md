---
title: "Graph.addEdge() method · @imqueue/sequelize"
description: "Adds edges from one vertex to others."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"Graph","url":"/api/sequelize/latest/sequelize.graph/"},{"name":"addEdge","url":"/api/sequelize/latest/sequelize.graph.addedge/"}]
sitemap: false
---
