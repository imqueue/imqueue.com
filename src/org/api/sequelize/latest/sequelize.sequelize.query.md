---
title: "Sequelize.query() method · @imqueue/sequelize"
description: "Runs a raw statement, honouring a returning column list."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"Sequelize","url":"/api/sequelize/latest/sequelize.sequelize/"},{"name":"query","url":"/api/sequelize/latest/sequelize.sequelize.query/"}]
sitemap: false
---
...
[QueryOptions](/api/sequelize/latest/sequelize.queryoptions/) \| QueryOptionsWithType&lt;QueryTypes.RAW&gt;
