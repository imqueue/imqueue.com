---
title: "BaseModel class · @imqueue/sequelize"
description: "The class every model in an @imqueue service extends."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"BaseModel","url":"/api/sequelize/latest/sequelize.basemodel/"}]
---
...
```
**Extends:** Model&lt;[BaseModel](/api/sequelize/latest/sequelize.basemodel/)<!-- -->&lt;T&gt;&gt;
...
[appendChild(name, data)](/api/sequelize/latest/sequelize.basemodel.appendchild/)
...
[drop(options)](/api/sequelize/latest/sequelize.basemodel.drop/)
...
[findAll(options)](/api/sequelize/latest/sequelize.basemodel.findall/)
...
[findByPk(identifier, options)](/api/sequelize/latest/sequelize.basemodel.findbypk/)
...
[findOne(options)](/api/sequelize/latest/sequelize.basemodel.findone/)
...
[fixNumbers()](/api/sequelize/latest/sequelize.basemodel.fixnumbers/)
...
[getViewDefinition(viewParams, asQuery)](/api/sequelize/latest/sequelize.basemodel.getviewdefinition/)
...
[restoreSerialization()](/api/sequelize/latest/sequelize.basemodel.restoreserialization/)
...
[sync(options)](/api/sequelize/latest/sequelize.basemodel.sync/)
...
[syncIndex(column, options, position)](/api/sequelize/latest/sequelize.basemodel.syncindex/)
...
[syncIndices(\_options)](/api/sequelize/latest/sequelize.basemodel.syncindices/)
...
[syncView(options)](/api/sequelize/latest/sequelize.basemodel.syncview/)
...
[toGraph(graph)](/api/sequelize/latest/sequelize.basemodel.tograph/)
...
[toJSON()](/api/sequelize/latest/sequelize.basemodel.tojson/)
