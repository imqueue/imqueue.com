---
title: "query.mergeQuery() function · @imqueue/sequelize"
description: "Merges query-option fragments into one options object."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"query","url":"/api/sequelize/latest/sequelize.query/"},{"name":"mergeQuery","url":"/api/sequelize/latest/sequelize.query.mergequery/"}]
sitemap: false
---
