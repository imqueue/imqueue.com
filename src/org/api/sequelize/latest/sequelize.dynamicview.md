---
title: "DynamicView() function · @imqueue/sequelize"
description: "Declares a model to be a view whose definition is parameterised per query."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"DynamicView","url":"/api/sequelize/latest/sequelize.dynamicview/"}]
---
