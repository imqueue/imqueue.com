---
title: "Sequelize.define() method · @imqueue/sequelize"
description: "Defines a model from an attribute map rather than from a decorated class."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/sequelize","url":"/api/sequelize/latest/"},{"name":"Sequelize","url":"/api/sequelize/latest/sequelize.sequelize/"},{"name":"define","url":"/api/sequelize/latest/sequelize.sequelize.define/"}]
sitemap: false
---
