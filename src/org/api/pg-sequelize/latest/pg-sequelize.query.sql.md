---
title: "query.sql() function · @imqueue/pg-sequelize"
description: "Normalises a SQL string: one-lined, whitespace collapsed, ending in a single semicolon."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"query","url":"/api/pg-sequelize/latest/pg-sequelize.query/"},{"name":"sql","url":"/api/pg-sequelize/latest/pg-sequelize.query.sql/"}]
sitemap: false
---
