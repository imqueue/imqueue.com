...
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"ColumnIndex","url":"/api/pg-sequelize/latest/pg-sequelize.columnindex/"}]
---
...
Partial&lt;[ColumnIndexOptions](/api/pg-sequelize/latest/pg-sequelize.columnindexoptions/)<!-- -->&gt;
