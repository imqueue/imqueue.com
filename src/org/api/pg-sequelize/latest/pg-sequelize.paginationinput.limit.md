---
title: "PaginationInput.limit property · @imqueue/pg-sequelize"
description: "Rows in the page. Negative counts back from the end of the set."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"PaginationInput","url":"/api/pg-sequelize/latest/pg-sequelize.paginationinput/"},{"name":"limit","url":"/api/pg-sequelize/latest/pg-sequelize.paginationinput.limit/"}]
sitemap: false
---
