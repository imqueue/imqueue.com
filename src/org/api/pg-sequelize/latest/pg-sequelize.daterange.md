---
title: "DateRange class · @imqueue/pg-sequelize"
description: "A range between two dates, as an @imqueue/rpc type."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"DateRange","url":"/api/pg-sequelize/latest/pg-sequelize.daterange/"}]
---
...
[end](/api/pg-sequelize/latest/pg-sequelize.daterange.end/)
...
[start](/api/pg-sequelize/latest/pg-sequelize.daterange.start/)
