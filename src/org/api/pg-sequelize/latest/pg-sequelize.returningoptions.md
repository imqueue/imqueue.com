---
title: "ReturningOptions interface · @imqueue/pg-sequelize"
description: "Widens returning so it can name the columns to fetch back, not just ask whether to fetch any."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"ReturningOptions","url":"/api/pg-sequelize/latest/pg-sequelize.returningoptions/"}]
---
...
[returning?](/api/pg-sequelize/latest/pg-sequelize.returningoptions.returning/)
