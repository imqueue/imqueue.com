---
title: "query.pureFields() function · @imqueue/pg-sequelize"
description: "Narrows a requested fields map to the model's own columns."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"query","url":"/api/pg-sequelize/latest/pg-sequelize.query/"},{"name":"pureFields","url":"/api/pg-sequelize/latest/pg-sequelize.query.purefields/"}]
sitemap: false
---
