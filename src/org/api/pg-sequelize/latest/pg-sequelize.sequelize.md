---
title: "Sequelize class · @imqueue/pg-sequelize"
description: "Sequelize's own connection class, taught about views, column indices and the widened returning option."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/pg-sequelize","url":"/api/pg-sequelize/latest/"},{"name":"Sequelize","url":"/api/pg-sequelize/latest/pg-sequelize.sequelize/"}]
---
...
[define(modelName, attributes, options)](/api/pg-sequelize/latest/pg-sequelize.sequelize.define/)
...
[getModelsWithIndices()](/api/pg-sequelize/latest/pg-sequelize.sequelize.getmodelswithindices/)
...
[getQueryInterface()](/api/pg-sequelize/latest/pg-sequelize.sequelize.getqueryinterface/)
...
[getViews()](/api/pg-sequelize/latest/pg-sequelize.sequelize.getviews/)
...
[query(sqlQuery, options)](/api/pg-sequelize/latest/pg-sequelize.sequelize.query/)
...
[sync(options)](/api/pg-sequelize/latest/pg-sequelize.sequelize.sync/)
...
[syncIndices(options)](/api/pg-sequelize/latest/pg-sequelize.sequelize.syncindices/)
...
[syncViews(options)](/api/pg-sequelize/latest/pg-sequelize.sequelize.syncviews/)
