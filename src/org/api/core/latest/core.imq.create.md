...
description: "Instantiates the queue adapter matching the given options and returns it ready to be started."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/core","url":"/api/core/latest/"},{"name":"IMQ","url":"/api/core/latest/core.imq/"},{"name":"create","url":"/api/core/latest/core.imq.create/"}]
---
