...
description: "Sends a message to the specified queue with the given data."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/core","url":"/api/core/latest/"},{"name":"IMessageQueue","url":"/api/core/latest/core.imessagequeue/"},{"name":"send","url":"/api/core/latest/core.imessagequeue.send/"}]
sitemap: false
---
