...
description: "Returns the listeners of every server's queue plus the internal template, concatenated."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/core","url":"/api/core/latest/"},{"name":"ClusteredRedisQueue","url":"/api/core/latest/core.clusteredredisqueue/"},{"name":"listeners","url":"/api/core/latest/core.clusteredredisqueue.listeners/"}]
sitemap: false
---
