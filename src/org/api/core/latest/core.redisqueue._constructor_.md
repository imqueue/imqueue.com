...
description: "Creates a queue handle. No connection is opened here — call RedisQueue.start(), or RedisQueue.send(), which starts the queue implicitly."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/core","url":"/api/core/latest/"},{"name":"RedisQueue","url":"/api/core/latest/core.redisqueue/"},{"name":"(constructor)","url":"/api/core/latest/core.redisqueue._constructor_/"}]
sitemap: false
---
