...
description: "Creates a subscription channel over redis and sets up channel data read handler. The effective Redis channel is <prefix>:<channel>."
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/core","url":"/api/core/latest/"},{"name":"RedisQueue","url":"/api/core/latest/core.redisqueue/"},{"name":"subscribe","url":"/api/core/latest/core.redisqueue.subscribe/"}]
---
