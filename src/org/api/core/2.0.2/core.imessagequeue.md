...
[Home](/api/) &gt; [@imqueue/core](/api/core/2.0.2/) &gt; [IMessageQueue](/api/core/2.0.2/core.imessagequeue/)
...
[clear()](/api/core/2.0.2/core.imessagequeue.clear/)
...
[destroy()](/api/core/2.0.2/core.imessagequeue.destroy/)
...
[publish(data, toName)](/api/core/2.0.2/core.imessagequeue.publish/)
...
[send(toQueue, message, delay, errorHandler)](/api/core/2.0.2/core.imessagequeue.send/)
...
[start()](/api/core/2.0.2/core.imessagequeue.start/)
...
[stop()](/api/core/2.0.2/core.imessagequeue.stop/)
...
[subscribe(channel, handler)](/api/core/2.0.2/core.imessagequeue.subscribe/)
...
[unsubscribe()](/api/core/2.0.2/core.imessagequeue.unsubscribe/)
