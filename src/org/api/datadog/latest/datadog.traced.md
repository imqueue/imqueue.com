---
title: "traced() function · @imqueue/datadog"
...
apiCrumbs: [{"name":"API reference","url":"/api/"},{"name":"@imqueue/datadog","url":"/api/datadog/latest/"},{"name":"traced","url":"/api/datadog/latest/datadog.traced/"}]
---
...
Partial&lt;[TracedOptions](/api/datadog/latest/datadog.tracedoptions/)<!-- -->&gt;


</td><td>

_(Optional)_ span kind and extra tags. `kind` defaults to [TraceKind.SERVER](/api/datadog/latest/datadog.tracekind/)<!-- -->; tags given here are applied last and override the automatic ones.
