...
([Providers](/cli/providers/#vcs-hosts---vcs)): GitHub needs `repo` (and `admin:org`
...
See [Configuration → Git transport](/cli/configuration/#git-transport-for-the-initial-push-https-vs-ssh).
...
See [Configuration](/cli/configuration/#environment-variable-reference).
