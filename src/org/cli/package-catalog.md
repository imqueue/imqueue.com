...
### The name a traced service reports {#the-name-a-traced-service-reports}
...
| [Template](/cli/custom-templates/#template-versions-v1-vs-v2) | Variable | How it resolves |
|---|---|---|
...
[Custom Templates](/cli/custom-templates/#token-substitution).
...
### Following the fleet {#following-the-fleet}
...
[Creating Services](/cli/creating-services/).
...
[Custom Templates](/cli/custom-templates/) and [Extensibility](/cli/extensibility/).
