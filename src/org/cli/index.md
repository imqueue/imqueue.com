...
the [@imqueue](/) framework — a Redis-backed RPC
...
> configs. See [Configuration](/cli/configuration/) and [Providers](/cli/providers/).
...
1. **[Installation](/cli/installation/)** — install the CLI and shell completions.
2. **[Configuration](/cli/configuration/)** — run `imq config init` to set your
   defaults (VCS host, CI, registry, namespaces, tokens).
3. **[Creating Services](/cli/creating-services/)** — scaffold your first service.
4. **[Managing Local Services](/cli/managing-local-services/)** — run many services
