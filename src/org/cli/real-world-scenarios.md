...
[Providers](/cli/providers/#enterprise--self-hosted).
...
Compare with `imq up` in [Clients & Versioning](/cli/clients-and-versioning/#update-version-vs-up).

## 7. Standardising new services for your org

Encode your conventions once in a [custom template](/cli/custom-templates/) and set
org defaults:
