...
description: "A layered strategy for testing Node.js microservices that call each other — unit-testing service classes directly and using typed generated clients as seams."
...
You end up with a fast, reliable majority of tests and a small, deliberate set of heavy ones — instead of one giant, flaky end-to-end suite. To structure services this way from the start, see [Getting Started](/get-started/) and the client-generation workflow in the [Tutorial](/tutorial/).
