...
description: "Why REST is often the wrong fit for internal Node.js service-to-service APIs, and when function-call (RPC) semantics are simpler — with @imqueue as one answer."
