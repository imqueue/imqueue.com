...
|---|---|---|---|---|
| [@imqueue/core](/api/core/latest/) | 3.5.3 | GPL-3.0-only | `>=22.12.0` | 2026-09-18 |
| [@imqueue/rpc](/api/rpc/latest/) | 3.9.4 | GPL-3.0-only | `>=22.12.0` | 2026-09-18 |
| [@imqueue/pg-pubsub](/api/pg-pubsub/latest/) | 3.0.9 | GPL-3.0-only | `>=22.12.0` | 2026-09-11 |
| [@imqueue/pg-cache](/api/pg-cache/latest/) | 5.1.8 | GPL-3.0-only | `>=22.12.0` | 2026-09-18 |
| [@imqueue/tag-cache](/api/tag-cache/latest/) | 3.0.12 | GPL-3.0-only | `>=22.12.0` | 2026-09-25 |
| [@imqueue/pg-sequelize](/api/pg-sequelize/latest/) | 4.2.9 | GPL-3.0-only | `>=22.12.0` | 2026-09-18 |
| [@imqueue/pg-prisma](/api/pg-prisma/latest/) | 3.0.0 | GPL-3.0-only | `>=22.12.0` | 2026-09-26 |
...
| [@imqueue/datadog](/api/datadog/latest/) | 3.2.6 | GPL-3.0-only | not declared | 2026-09-18 |
...
| [@imqueue/job](/api/job/latest/) | 3.3.4 | GPL-3.0-only | `>=22.12.0` | 2026-09-18 |
| [@imqueue/cli](/cli/) | 5.2.9 | GPL-3.0-only | `>=22.12.0` | 2026-09-18 |
| [@imqueue/mcp](/mcp/) | 3.7.9 | GPL-3.0-only | `>=18` | 2026-09-18 |
<!-- status:end packages -->
