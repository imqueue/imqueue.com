...
// lib/agent-analytics.ts for what is sent and why. This is the only place in the
...
export async function onRequest(context: PagesContext): Promise<Response> {
  ...
  try {
    ...
    // lib/markdown-link.ts for the URL rule and for why it lives in its own module.
    //
    ...
    // That covers the header too — a failed rebuild falls through to the original
    // response rather than costing the request.
  }
