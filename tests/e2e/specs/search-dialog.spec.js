// search-dialog.spec.js — the modal search, which is the site's main way in.
//
// Search is three separable things and this file only tests the third: the ranker
// (scripts/lib/ranker.js, measured by `npm run kpi`), the index (checked by
// check-search-index.js) and the SURFACE — whether a reader can open it, type,
...
const { openSearch, searchFor } = require('../support/site');

test.describe('opening and closing', () => {
  for (const how of ['button', 'slash', 'ctrl-k']) {
