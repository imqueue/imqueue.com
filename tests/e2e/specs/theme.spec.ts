// theme.spec.ts — the three-way theme switch, which is the site's only piece of
...
import { THEME_KEY } from '../support/fixtures';

const root = (page: Page) => page.locator('html');
const bar = (page: Page) => page.locator('.nav-actions .theme-toggle');
...
test.describe('theme switch', () => {
  ...
  test('the choice survives a navigation and is applied before first paint', async ({ page }) => {
    ...
    // The head script, not site.ts: assert the attribute is set at the moment the
